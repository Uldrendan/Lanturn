...
function OnMouseUp() {
	...
	GameObject.Find("Main Camera").SendMessage("SaveTilt");
	GameObject.Find("Main Camera").SendMessage("SaveVibrate");
	GameObject.Find("Main Camera").SendMessage("SaveMusic");
	GameObject.Find("Main Camera").SendMessage("SaveSound");
